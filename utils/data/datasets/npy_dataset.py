...
class npyDataset(Dataset):
    ...
    ----------
        arrays_path : str
            Path containing image arrays to be loaded into the dataset
        transform : torchvision.transforms object
            Desired transform to be performed on the array data. Default is the torch.from_numpy() transformation
